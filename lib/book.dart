...
List<Book> listBook = [
 ...
 Book(
     ...
     description:
         'Hyper-V adalah platform virtualisasi yang dikembangkan oleh Microsoft. Hal ini memungkinkan Anda membuat dan mengelola mesin virtual (VM) pada satu mesin fisik, memungkinkan pemanfaatan sumber daya yang lebih baik dan fleksibilitas dalam mengelola infrastruktur TI.',
     rate: 4.2,
     page: 210,
     categoryBook: 'Sysadmin IDN',
     language: 'IDN'),
